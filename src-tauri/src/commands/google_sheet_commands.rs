...
pub async fn init_google_sheet_command(
    ...
    let t: Result<Option<TokenResponse>, String> = google_service.lock().await.init_google_service(&json_path).await .map_err(|e| e.to_string());
    t
}
...
pub async fn get_invoices(
    ...
    let r = google_service.lock().await.get_invoices(sheet_name, spreadsheet_id)
        .await
...
pub async fn get_sheet_stats(
    ...
    let r = google_service.lock().await.get_sheet_stats(sheet_name, spreadsheet_id)
        .await
        .map_err(|e| e.to_string());
    r
}
...
pub async fn set_invoices(
    ...
    let r = google_service.lock().await.set_invoices(sheet_name, spreadsheet_id, items)
        .await
        .map_err(|e| e.to_string());
    r
}
...
pub async fn list_sheets(
    ...
    let r = google_service.lock().await.list_sheets(spreadsheet_id)
        .await
        .map_err(|e| e.to_string());
    r
}
